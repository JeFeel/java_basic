...
//        double d = 3.14;
        ...
        switch (season){
            ...
            case "여름": case "summer": case "SUMMER": case "夏":
                System.out.println("여름에는 홍천을 가세요!"); break;
            case "가을":
                System.out.println("가을에는 춘천을 가세요!"); break;
            case "겨울":
                System.out.println("겨울에는 스키장을 가세요!"); break;
            default: //else와 같은 효과
                System.out.println("계절을 잘 입력해주세요");
        }*/
        System.out.println("================");
        ...
        switch(answer.toLowerCase().charAt(0)){ //무슨 말을 써도 소문자로 변환+첫글자만 반환
            case'y': case'ㅛ':
